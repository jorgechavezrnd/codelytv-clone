...
test: composer-env-file
	docker exec codelytv-codelytv_clone-mooc_backend-php ./vendor/bin/behat -p mooc_backend --format=progress -v
...
clean-cache:
	@rm -rf apps/*/*/var
	@docker exec codelytv-codelytv_clone-mooc_backend-php ./apps/mooc/backend/bin/console cache:warmup
